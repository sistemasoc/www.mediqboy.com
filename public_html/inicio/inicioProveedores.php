      ...
      <div class="rox">
        <div class="col-md-7">
          ...
          <div class="main-title">
            <h2><span>Inicio sesión proveedores</span> </h2>
          ...
          <div class="form" id="divLogin">        
            <div class="row">
              ...
              <form name="contact_form" id="contact_form" method="post" action="#" onSubmit="return false">
                ...
                <div class="col-md-8"><input type="text" data-delay="300" placeholder="Nit sin DV" name="id_proveedor" id="id_proveedor" class="input " autofocus="" autocomplete="false"></div>
                <div class="col-md-8"><input type="password" data-delay="300" placeholder="Contraseña" name="pass_proveedor" id="pass_proveedor" class="input" autocomplete="false"></div>
                <div class="col-md-8"><input name=" " type="submit" value="Ingresar" onClick="validateProveedores();"></div>
              </form>                    
            </div>        
            <br>                        
          ...
          <div class="form" id="divRecuperar" hidden="">        
            <div class="row">
              ...
              <form name="recuperar_form" id="recuperar_form" method="post" action="#" onSubmit="return false">                
                ...
                <div class="col-md-8">
                  <div class="col-md-8"><input type="hidden" name="ip" id="ip" class="input" value="<?php echo $ip; ?>"></div>
                  <input type="text" data-delay="300" placeholder="Nit sin DV" name="id_proveedorRecuperar" id="id_proveedorRecuperar" class="input " autofocus="" autocomplete="false">
                  <br>
                  <p class="error" id="error1" style="display:none; color:red"></p>                  
                </div>                
                
                <div class="col-md-8"><input name=" " type="submit" value="Solicitar" onClick="validateRecuperarProveedores();" id="btnSolicitar"></div>
              </form>                    
            </div>        
            <br>                                    
          </div>          
        ...
        <div class="col-md-5">
          ...
          <div class="detail">
            ...
            <span><a href="#."><i class="icon-mail"> </i><b>  &nbsp;&nbsp;Email:</b> oc.compras@mediqboy.com</a></span>                        
           </div>
...
<script type="text/javascript" src="js/inicioclientes.js?v=5"></script>
